public class Wizard extends Character implements Attacker {
    ...
    public String attack(Character character) {
        ...
        if( random == 1 && this.mana >= 5){
            ...
            System.out.println(getName() + " has attacked with a Fireball, his Mana has reduced to " + this.mana + "\n" + character.getName() + " was attacked and his HP is now " + character.getHp() + "\n" + "=====================");
            ...
            System.out.println(getName() + " does not have enough mana to cast a spell, his Mana was restored to " + this.mana + "\n" + "=====================");
    ...
    public String toString() {
        System.out.println(Wizard.super.toString() + "\n" + "Character Class: Wizard ," +
                "Mana: " + mana +
